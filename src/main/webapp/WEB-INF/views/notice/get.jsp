		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel panel-heading">
					<h3 class="mt-5 mb-3">공지사항 > 글읽기</h3>
				</div>
				<div class="panel panel-body border">
					...
					<form id="opForm" action="/notice/modify" method="get">
...
<!-- 게시글수정		,	 go to /notice/list -->
<script type="text/javascript">
	$(document).ready(function(){
		var opForm = $("#opForm");
		$("button[data-oper='modify']").on("click",
			function(){
				opForm.attr("action", "/notice/modify").submit();
		});
		$("button[data-oper='list']").on("click",
			function(){
				opForm.find("#bno").remove();
				opForm.attr("action", "/notice/list").submit();
		});
	});
</script>
