		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel panel-heading">
					<h3 class="mt-5 mb-3">커뮤니티 > 게시글 수정</h3>
				</div>
				<div class="panel panel-body">
					<form role="form" action="/community/modify" method="post" id="opForm">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function(e){
			...
			if(operation === 'remove'){
				opForm.attr("action", "/community/remove");
				...
				if(location){
					...
					opForm.attr("action", "/community/list").attr("method", "get");
