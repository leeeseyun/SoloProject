		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel panel-heading">
					<h3 class="mt-5 mb-3">이벤트 > 게시글 수정</h3>
				</div>
				<div class="panel panel-body">
					<form role="form" action="/event/modify" method="post" id="opForm">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function(e){
			...
			if(operation === 'remove'){
				opForm.attr("action", "/event/remove");
				...
				if(location){
					...
					opForm.attr("action", "/event/list").attr("method", "get");
