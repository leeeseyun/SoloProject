		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel panel-body border">
					...
					<form id="opForm" action="/event/modify" method="get">
...
<!-- 게시글수정		,	 go to /event/list -->
<script type="text/javascript">
	$(document).ready(function(){
		var opForm = $("#opForm");
		$("button[data-oper='modify']").on("click",
			function(){
				opForm.attr("action", "/event/modify").submit();
		});
		$("button[data-oper='list']").on("click",
			function(){
				opForm.find("#bno").remove();
				opForm.attr("action", "/event/list").submit();
		});
	});
</script>
